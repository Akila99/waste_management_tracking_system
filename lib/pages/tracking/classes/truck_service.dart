...
class TruckService {
  ...
  Future<List<Map<String, dynamic>>> fetchTruckDetails(String wardName,
      String provinceId, String districtId, String councilId) async {
    ...
    try {
      // Access the specific ward collection
      var wardSnapshot = await _firestore
          .collection('province')
          .doc(provinceId)
      ...
      var truckSnapshot = await trucksCollection.get();
      ...
      debugPrint("Error fetching truck details: $e");
      return [];
    }
  }
